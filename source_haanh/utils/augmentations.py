...
class RandomSampleCrop(object):
    ...
    def __call__(self, image, masks, boxes=None, labels=None):
        ...
        while True:
            # randomly choose a mode (use Python's random.choice because
            # numpy.random.choice tries to coerce the sequence to an array
            # and fails for heterogeneous elements like None and tuples)
